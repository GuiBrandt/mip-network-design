...
// [2] Implementing the Dantzig-Fulkerson-Johnson algorithm for large traveling
// salesman problems. Mathematical Programming, 2003, Volume 97, Issue 1-2, pp 91-153.
//
...
protected:
  ...
  { // --------------------------------------------------------------------------------
    ...
    // Exercicio em Aula
    //=======================================================
    // Compare a execucao do codigo comentando ou nao
    // as 3 linhas idenficadas abaixo com  /* SepInt */
    //
    /* SepInt */ else if ((where==GRB_CB_MIPNODE) &&  
    /* SepInt */   (getIntInfo(GRB_CB_MIPNODE_STATUS)==GRB_OPTIMAL))// node with optimal fractional solution
    /* SepInt */   {solution_value = &subtourelim::getNodeRel;}
	...
	addLazy( expr >= 2 );
	// Aula: Remova ou deixe comentado a linha abaixo (o comando "break").
	break;
      }
...
int main(int argc, char *argv[]) 
{
  ...
  for (EdgeIt e(g); e!=INVALID; ++e) {
    aux = "x_"+vname[g.u(e)]+"_"+vname[g.v(e)];
    x[e] = model.addVar(0.0, 1.0, weight[e],GRB_BINARY,aux);  }
